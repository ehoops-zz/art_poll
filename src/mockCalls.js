export function getPoll(pollID) {
  // This would be replaced with an API call to
...
export function addRating(entryID, rating) {
  // This would be replaced with a call to
  // POST vn.com/api/polls/:poll_id/vote
  console.log(`Added rating ${rating} for entry with id: ${entryID}`);
  return;
}
